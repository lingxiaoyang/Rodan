...
path = raw_input(
    "Please enter a path to a directory containing the files to be converted:\n"
)
...
for image in images:  # for each image
    ...
    img.save(
        "./Converted/" + img_name + "." + img_type
    )  # save the image in desired (ex: 'png') format in the "Converted" directory
